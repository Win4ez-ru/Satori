"""Offline contract for the v23 practical-care human-reviewed OpenAI gate."""
...
FIXTURE_PATH = Path(__file__).with_name("fixtures") / "checkpoint142_character_sampling_v5.json"


def test_v23_sampling_corpus_is_exact_bounded_and_human_reviewed() -> None:
    ...
    assert corpus["corpus_id"] == V23_GATE_SPEC.corpus_id
    assert corpus["policy_id"] == "satori.conversation.behavior.v23"
